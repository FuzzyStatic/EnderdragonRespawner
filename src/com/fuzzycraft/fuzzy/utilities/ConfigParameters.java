 ...
 * @Last Modified time: 2018-01-20 18:08:07
 */
...
public class ConfigParameters {
  ...
  private static final String PATH_RESPAWN_CRYSTALS =
      PATH_RESPAWN + ".enderCrystals";
  private static final String PATH_RESPAWN_OBSIDIAN =
      PATH_RESPAWN + ".obsidian";
  ...
  public boolean getActive() { return this.config.getBoolean(PATH_ACTIVE); }
  ...
  public int getAmount() { return this.config.getInt(PATH_AMOUNT); }

  public int getTime() { return this.config.getInt(PATH_TIME); }

  public String getMsg() { return this.config.getString(PATH_MSG); }
